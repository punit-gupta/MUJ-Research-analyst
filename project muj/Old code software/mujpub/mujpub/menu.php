                       ...
                       <li class="nav-label">Features</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Reports <span class="label label-rouded label-success pull-right">5</span></span></a>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="jc.php">Journal\Conferences</a></li>
                                <li><a href="au.php">Authors</a></li>
                            </ul>
                        ...
                        <li> <a  href="doi.php" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Doi </span></a>
                        </li>
                        <li> <a  href="update.php" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Update </span></a>
                        </li>
						<li> <a  href="bulkupdate.php?field=Journal" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Update bulk</span></a>
                        </li>
