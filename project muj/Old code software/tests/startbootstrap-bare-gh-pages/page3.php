...
$query = "SELECT journal, COUNT(*) AS `num` FROM article GROUP BY journal";
...
<table class="tablesorter" class="table">
		<thead>
			<tr>
				<th>S.No</th>
				<th>Journal/Conference Proceedings</th>
				<th>Count</th>
		...
		<tbody>
		 <tbody>
            ...
            <tr>
				...
				<input type="hidden" name="field" id="hiddenField" value="journal"/>
