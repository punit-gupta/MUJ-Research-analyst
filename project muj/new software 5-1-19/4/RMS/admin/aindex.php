	  ...
	  <?php include 'menua.php';?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
								...
								<a href="../user/rallarticle.php?user=admin">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            ...
                            <div class="media">
								...
								<a href=../user/selected.php?type=Journal&user=admin >
                                <div class="media-body media-text-right">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
								...
								<a href=../user/selected.php?type=Conference%20Paper&user=admin >
                                <div class="media-body media-text-right">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
								...
								<a href=../user/selected.php?type=Book&user=admin >
                                <div class="media-body media-text-right">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
								...
								<a href=../user/selected.php?type=Book%20Chapter&user=admin >
                                <div class="media-body media-text-right">
                ...
                <div class="row">
			<?php include '/plugin/year_pub.php';?>		
			<?php include '/plugin/scopus_pub.php';?>			
			<?php include '/plugin/sci_pub.php';?>		
			<?php include '/plugin/top5_au.php';?>
			<?php include '/plugin/dept_pub.php';?>	
			<?php include '/plugin/citation.php';?>				
				</div>	
