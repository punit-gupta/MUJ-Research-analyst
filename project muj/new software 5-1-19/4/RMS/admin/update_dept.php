                ...
                <div class="row">
                    ...
                    <div class="card-body">
					 <li class="nav-label">Search UID</li>
									...
									$query = "SELECT * FROM articlec where uid='$name'";
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
											 ...
											 <tbody>
												...
												$query1 = "SELECT * FROM authorc where uid='$row1[27]'";
												...
												<form method="POST" action="update1.php">
												  ...
												  <tr> <td>Author</td> 				<td><input class="form-control"type="text" name="author" value="<?php echo $auth;?>" disabled></td></tr>
												  ...
												  <tr> <td>Pages</td> 				<td><input class="form-control"type="text" name="pages" value="<?php echo $row1[5];?>"></td></tr>
												    <tr> <td>doi</td> 				<td><input class="form-control"type="text" name="doi" value="<?php echo $row1[6];?>"></td></tr>
													  <tr> <td>URL</td> 				<td><input class="form-control"type="text" name="doi" value=" http://dx.doi.org/<?php echo $row1[7];?>"></td></tr>
												  <tr> <td>Affiliation</td> 		<td><input class="form-control"type="text" name="affiliation" value="<?php echo $row1[8];?>"></td></tr>
												    <tr > <td>Abstract</td> <td><textarea  class="form-control" name="abstract" rows="10" cols="30"> <?php echo $row1[9];?></textarea></td></tr>
													
														
												  <tr> <td>Publisher</td> 				<td><input class="form-control"type="text" name="doi" value="<?php echo $row1[12];?>"></td></tr>
												...
												<tr> <td>Type</td> 				
												  ...
												  <tr> <td>Indexing SCOPUS</td> 				<td><input class="form-control"type="text" name="ISBN" value="<?php echo $row1[19];?>"></td></tr>
												  <tr> <td>Indexing SCI</td> 				<td><input class="form-control"type="text" name="ISBN" value="<?php echo $row1[20];?>"></td></tr>
												  <tr> <td>Indexing ESI</td> 				<td><input class="form-control"type="text" name="ISBN" value="<?php echo $row1[21];?>"></td></tr>
												  <tr> <td>Indexing UGC</td> 				<td><input class="form-control"type="text" name="ISBN" value="<?php echo $row1[22];?>"></td></tr>
