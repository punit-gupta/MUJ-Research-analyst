                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                           <?php
                                                ...
                                                $query = "SELECT COUNT(DISTINCT doi), department FROM author GROUP by department";
                                                $result = mysqli_query($connect, $query);
                                            ...
                                            <tr>
                                                  ...
                                                  <td class="color-primary"><a href=../user/selected3.php?dept=<?php echo $dept; ?>><?php echo $row1[1]; ?></a></td>
												   <th scope="row"><?php echo $row1[0]; ?></th>
