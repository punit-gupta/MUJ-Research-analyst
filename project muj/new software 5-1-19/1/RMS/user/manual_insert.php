...
$sql = "INSERT INTO `articlec` (`author`, `title`, `journal`, `year`,`volume`, `pages`, `doi`, `url`, `affiliation`, `abstract`, `keyword`, `correspondence_address1`, `publisher`, `issn`,`isbn`, `language`, `abbrev_source_title`, `document_type`, `source`,`index scopus`, `index SCI`, `index esci`, `index ugc`, `date`) 
							...
							if ($a2) {
								...
								{		$c=$c+1;
								 ...
								 if($a1&$a2)
								    {
									//echo $author."-";
									$sql = "INSERT INTO `authorc` (`author`, `doi`, `department`,`date`,`ord`) VALUES ('$author', '$doi', '',now(),'$c');";
