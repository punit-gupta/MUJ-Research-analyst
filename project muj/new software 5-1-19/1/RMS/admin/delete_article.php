        ...
        <div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
						...
						<?php
							...
							$connect = mysqli_connect($hostname, $username, $password, $databaseName);
								...
								$query = "SELECT  date, COUNT(doi) FROM `article` GROUP BY date";
               ...
               <div class="col-lg-12">
                        ...
                        <input type="text" placeholder="Search Round" class="form-control" name="doi" value="10.1037/0022-3514.65.6.1190"  >
