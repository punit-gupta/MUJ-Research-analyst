                 ...
                 <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="aindex.php" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard </a></li>
						 ...
						 <li> <a  href="add_project.php" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Add Project </span></a>
						 <li> <a  href="backup.php" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Backup Project </span></a>
                        </li>
