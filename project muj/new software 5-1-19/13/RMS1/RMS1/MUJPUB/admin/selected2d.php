				...
				<div class="row">
				 ...
				 <div class="col-lg-12">
                        <div class="card">
							...
							{
							echo '<div id=\'BOOK\' ></div><script>loadDoc(\'article_cite.php?BOOK=BOOK&SCOPUS=SCOPUS&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK")) ;</script>';
							}
							else if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCI')
							{echo '<div id=\'BOOK\' ></div><script>loadDoc(\'article_cite.php?BOOK=BOOK&SCI=SCI&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\' ;</script>';
							}
							else 
							{echo '<div id=\'BOOK\' ></div><script>loadDoc(\'article_cite.php?BOOK=BOOK&D='.$dept.'\',document.getElementById("BOOK")) ;</script>';
				 ...
				 <div class="col-lg-12">
                        <div class="card">
							...
							if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCOPUS')
							{
							echo '<div id=\'BOOK1\' ></div><script>loadDoc(\'article_cite.php?BOOKC=BOOK+CHAPTER&SCOPUS=SCOPUS&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK1")) ;</script>';
							}
							else if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCI')
							{echo '<div id=\'BOOK1\' ></div><script>loadDoc(\'article_cite.php?BOOKC=BOOK+CHAPTER&SCI=SCI&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK1")) ;</script>';
							}
							else
							{echo '<div id=\'BOOK1\' ></div><script>loadDoc(\'article_cite.php?BOOKC=BOOK+CHAPTER&D='.$dept.'\',document.getElementById("BOOK1")) ;</script>';
							}
							?>
					  ...
					  <div class="col-lg-12">
                        <div class="card">
							...
							if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCOPUS')
							{
							echo '<div id=\'BOOK2\' ></div><script>loadDoc(\'article_cite.php?JOURNAL=JOURNAL&SCOPUS=SCOPUS&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK2")) ;</script>';
							}
							else if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCI')
							{echo '<div id=\'BOOK2\' ></div><script>loadDoc(\'article_cite.php?JOURNAL=JOURNAL&SCI=SCI&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK2")) ;</script>';
							}
							else
							{echo '<div id=\'BOOK2\' ></div><script>loadDoc(\'article_cite.php?JOURNAL=JOURNAL&D='.$dept.'\',document.getElementById("BOOK2")) ;</script>';
							}
							?>
					  ...
					  <div class="col-lg-12">
                        <div class="card">
							...
							if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCOPUS')
							{
							echo '<div id=\'BOOK3\' ></div><script>loadDoc(\'article_cite.php?CONFERENCE=CONFERENCE&SCOPUS=SCOPUS&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK3")) ;</script>';
							}
							else if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCI')
							{echo '<div id=\'BOOK3\' ></div><script>loadDoc(\'article_cite.php?CONFERENCE=CONFERENCE&SCI=SCI&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK3")) ;</script>';
							}
							else 
							{echo '<div id=\'BOOK3\' ></div><script>loadDoc(\'article_cite.php?CONFERENCE=CONFERENCE&D='.$dept.'\',document.getElementById("BOOK3")) ;</script>';
							}
							?>  </div>
                    </div>
					<?php }?>
					<?php
                        ...
                        <div class="card">
							...
							if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCOPUS')
							{
							echo '<div id=\'BOOK4\' ></div><script>loadDoc(\'article_cite.php?OTHER=OTHER&SCOPUS=SCOPUS&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK4")) ;</script>';
							}
							else if(isset($_GET["year"]) && isset($_GET["index"]) &&$_GET["index"]=='SCI')
							{echo '<div id=\'BOOK4\' ></div><script>loadDoc(\'article_cite.php?OTHER=OTHER&SCI=SCI&D='.$dept.'&'.$_GET["year"]."=".$_GET["year"].'\',document.getElementById("BOOK4")) ;</script>';
							}
							else
							{echo '<div id=\'BOOK4\' ></div><script>loadDoc(\'article_cite.php?OTHER=OTHER&D='.$dept.'\',document.getElementById("BOOK4")) ;</script>';
							}
							?>
                        </div>
