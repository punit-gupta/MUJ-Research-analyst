        ...
        scales: {
            ...
            xAxes: [{
				...
				<div class="row">
					...
					$query2 = "SELECT COUNT(*) AS `num` FROM article where `index SCI` ='SCI' and uid in (SELECT DISTINCT uid FROM author where department='$dept')";                                     											    $result2 = mysqli_query($connect, $query2);
					$result2 = mysqli_query($connect, $query2);
					$row12 = mysqli_fetch_array($result2);
					$ws =$row12[0];   
            ...
            <?php include '../admin/plugin/department/year_pub.php';?>		
			<?php include '../admin/plugin/department/scopus_pub.php';?>			
			<?php include '../admin/plugin/department/sci_pub.php';?>		
			<?php include '../admin/plugin/department/top5_au.php';?>
			<?php include '../admin/plugin/department/author_list.php';?>
			<?php include '../admin/plugin/department/popular_journal.php';?>
