<div class="col-sm-10 col-md-10">
                        <div class="card">
                            <div class="card-title">
                              <h4>Citation vs Article Count vs Conference Ratio </h4>

                            </div>
                            <div class="sales-chart">
                              <canvas id="chartJSContainer61"></canvas>
                            </div>
                        </div>
                        <!-- /# card -->
                    </div>
			...
			scales: {
				yAxes: [{
					...
					ticks: {
						display: true,
						min:-1000,
						max:<?php echo $max1+1000+$radious1;?>,
...
var ctx = document.getElementById('chartJSContainer61').getContext('2d');
