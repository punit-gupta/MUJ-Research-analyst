                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
											$query = "SELECT author, COUNT(*) AS `num` FROM author where department!='NA' and type='MUJ' and uid in (SELECT DISTINCT uid FROM author where department='$dept') and type='MUJ' GROUP BY author order by num desc";
