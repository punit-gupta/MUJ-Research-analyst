...
$query = "SELECT * FROM article where title='$title' or doi='$doi' ";
...
{ $row1 = mysqli_fetch_array($result);
	...
	if($web=="WEB")
	{$sql = "update article set `web`='WEB' where uid='$row1[27]';";
		$a5=mysqli_query($connect,$sql);
	}
	if($esci=="ESCI")
...
if($uid!='')
{
$sql = "INSERT INTO `article` (`author`, `title`, `journal`, `year`,`volume`, `pages`, `doi`, `url`, `affiliation`, `abstract`, `keyword`, `correspondence_address1`, `publisher`, `issn`,`isbn`, `language`, `abbrev_source_title`, `document_type`, `source`,`index scopus`, `index SCI`, `index esci`, `index ugc`, `date`,`uid`,`web`) 
VALUES ('$authorss', '$title', '$journal ', '$year', '$volume','$pages','$doi', '', '$affiliation', '$abstract', '', '', '$publisher', '$issn', '$isbn', '', '', '$document_type','','$scopus','$sci','$esci','$ugc','$date','$uid','$web')";
