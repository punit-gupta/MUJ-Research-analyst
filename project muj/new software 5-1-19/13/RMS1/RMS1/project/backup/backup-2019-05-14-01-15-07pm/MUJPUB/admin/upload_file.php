                ...
                <div class="row">
					...
					<div >
                                   <form  action=""  method="POST" enctype="multipart/form-data">
										...
										<div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Web of Science<span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                                                        <input type="radio" class="css-control-input" id="val-terms" name="web" value="WEB"  >
                                                                                        <span class="css-control-indicator"></span> Web of Science
                                                 </label>
												 <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                                                        <input type="radio" class="css-control-input" id="val-terms" name="web" value="NO"  checked>
                                                                                        <span class="css-control-indicator"></span> NO
                                                 </label>
                                            </div>
                                        </div>
   ...
   if(isset($_FILES['image'])&&isset($_POST['SCOPUS'])&&isset($_POST['SCI'])&&isset($_POST['ESCI'])&&isset($_POST['UGC'])){
	...
	$scopus=$_POST['SCOPUS'];
      ...
      if(empty($errors)==true){
		  $file='upload'.'-'.date("Y-m-d-h-i-s").".bib";
		  $query = "INSERT INTO `upload` (`date`, `filename`) VALUES ('".date("Y-m-d-h-i-sa")."', '".$file."');";
		  $result = mysqli_query($connect, $query);
		 

         move_uploaded_file($file_tmp,"uploads/".$file);
         echo "file uploaded Success";
		 ?><a href=upload_file2.php?name=<?php echo"uploads/".$file."&SCOPUS=".$scopus."&SCI=".$sci."&web=".$web."&ESCI=".$esci."&UGC=".$ugc;?>> MOVE TO NEXT STEP
		 </a><?php
      }else{
         print_r($errors);
      }
