                    ...
                    <div class="card-body">
					 <li class="nav-label">Group BY</li>
										<form action = "<?php $_PHP_SELF ?>" method = "POST" align=center>
										 ...
										 <select name="name" class="form-control input-rounded">
					 ...
					 <li class="nav-label">Search unique [Journal, Year,Type]</li>
										<form action = "<?php $_PHP_SELF ?>" method = "POST" align=center>
											<div class="input-group input-group-rounded">	
						...
						<li class="nav-label">Search BY [Title,DOI,ISSN, ISBN]</li>
										<form action = "<?php $_PHP_SELF ?>" method = "POST" align=center>
										  <div class="input-group input-group-rounded">	
										  <select name="fie" class="form-control input-rounded">
											<option value="title">Title</option>
					...
					<div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
									...
									$query = "SELECT * FROM article WHERE $fie like '%$name1%'";
									$result = mysqli_query($connect, $query);
                                            ...
                                            <tr>
											 ...
											 <tbody>
											   ...
											   <!-- populate table from mysql database -->
												...
												<tr>
													<td><?php echo $sno;?></td>
													<td><a href='article.php?name=<?php echo $row1[27];?>'><?php echo $row1[1];?></a></td>
