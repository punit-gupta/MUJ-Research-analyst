				...
				if( isset($_GET["type"]) && $_GET["type"]!="other")
					...
					<div class="col-lg-12">
                        <div class="card">
							...
							if(isset($_GET["year"]))
							{$year=$_GET["year"];
								$query = "SELECT * FROM `article` WHERE  (document_type='Editorial' or document_type='Letter') and year='$year'";
								
							}
							else
							{
								$query = "SELECT * FROM `article` WHERE  document_type='Editorial' or document_type='Letter'";
							}
