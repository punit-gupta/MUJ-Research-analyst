	  ...
	  <?php include 'menu.php';?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-university f-s-40" style="color:green"></i></span>
                                </div>
								<a href="rallarticle.php">
                                <div class="media-body media-text-right">
                                    <h2><?php echo $sum; ?></h2>
                                    <p class="m-b-0">Research Units</p>
                                </div>
								</a>
                            </div>
                        </div>
					...
					<div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-handshake-o f-s-40 color-primary"></i></span>
                                </div>
								<a href="rallarticle.php">
                                <div class="media-body media-text-right">
                                    <h2><?php echo $sum; ?></h2>
                                    <p class="m-b-0">Collaborations</p>
                                </div>
								</a>
                            </div>
                        </div>
				...
				<?php include '../user/graph/all_pub.php';?>		 
            ...
            <?php include '../user/plugin/year_pub.php';?>		
			<?php include '../user/plugin/scopus_pub.php';?>			
			<?php include '../user/plugin/sci_pub.php';?>		
			<?php include '../user/plugin/top5_au.php';?>
			  <?php include '../user/plugin/citation.php';?>
			  <?php include '../user/plugin/dept_pub.php';?>
			  <?php include '../user/plugin/dept_contribution.php';?>
			    <?php include '../user/plugin/topcite_article.php';?>
				</div>

          		 <div class="row">
                    
                   <?php include '../user/graph/geo_world.php';?>
                </div>
