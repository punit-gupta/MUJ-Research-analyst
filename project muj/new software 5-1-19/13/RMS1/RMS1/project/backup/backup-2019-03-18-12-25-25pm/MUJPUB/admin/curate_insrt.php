...
$a6=true;
								...
								if($a1)
								{
									...
									$sql="INSERT INTO `author` (`author`, `doi`, `department`,`date`,`ord`,`uid` ) VALUES ('$author', '$doi', '',now(),'$i','$uid')";
									echo $sql."<br>";
									$a4=mysqli_query($connect,$sql);
									$a5=true;
									if($a4)
							...
							$a4=mysqli_query($connect, "DELETE FROM `articlec` WHERE uid='$uid';");
							$a2=mysqli_query($connect,"DELETE FROM `authorc` WHERE uid='$uid';");	
