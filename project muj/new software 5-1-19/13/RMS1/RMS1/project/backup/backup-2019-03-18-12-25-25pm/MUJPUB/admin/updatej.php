                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
											 <?php
												...
												<input type="hidden" name="name1" id="hiddenField" value="yes"/>
												 ...
												 <tr> <td>Indexing UGC</td><td><input class="form-control"type="text" name="UGC" value="<?php echo $row1[22];?>"></td></tr>
												  ...
												  <tr> <td>Document type</td><td><input class="form-control"type="text" name="type" value="<?php echo $row1[17];?>"></td></tr>
