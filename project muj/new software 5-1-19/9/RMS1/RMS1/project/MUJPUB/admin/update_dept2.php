                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="40%">
                                        <thead>
												 ...
												 $query1 = "SELECT * FROM author where uid='$row1[27]'";
												  ...
												  echo "$a";
													...
													{ 
														...
														if(strpos($a, 'Computer and Communication') )
														{
													     $dept[0]="selected='selected'";
														}
														if(strpos($a, 'Computer Science and Engineering') )
														{
													     $dept[1]="selected='selected'";
														}
														if(strpos($a, 'Information Technology') )
														{
													     $dept[2]="selected='selected'";
														}
														if(strpos($a, 'Chemical Engineering') )
														{
													     $dept[3]="selected='selected'";
														}
														if(strpos($a, 'Civil Engineering') )
														{
													     $dept[4]="selected='selected'";
														}
														if(strpos($a, 'Fine Arts') )
														{
													     $dept[5]="selected='selected'";
														}
														if(strpos($a, 'Mechatronics') )
														{
													     $dept[6]="selected='selected'";
														}
														if(strpos($a, 'Mechanical') )
														{
													     $dept[7]="selected='selected'";
														}
														if(strpos($a, 'Automobile Engineering') )
														{
													     $dept[8]="selected='selected'";
														}
														if(strpos($a, 'Electronics & Communication') )
														{
													     $dept[9]="selected='selected'";
														}
														if(strpos($a, 'Electrical & Electronics') )
														{
													     $dept[10]="selected='selected'";
														}
														if(strpos($a, 'Physics') )
														{
													     $dept[11]="selected='selected'";
														}
														if(strpos($a, 'Mathematics & Statistics') )
														{
													     $dept[12]="selected='selected'";
														}
														if(strpos($a, 'chemistry'))
														{
													     $dept[13]="selected='selected'";
														}
														
														
														if(strpos($a, 'Biosciences') )
														{
													     $dept[14]="selected='selected'";
														}
														if(strpos($a, 'Interior Design') )
														{
													     $dept[15]="selected='selected'";
														}
														if(strpos($a, 'Fashion Design') )
														{
													     $dept[16]="selected='selected'";
														}
														if(strpos($a, 'Planning') )
														{
													     $dept[17]="selected='selected'";
														}
														if(strpos($a, 'Architecture & Design') )
														{
													     $dept[18]="selected='selected'";
														}
														if(strpos($a, 'Journalism & Mass Communication') )
														{
													     $dept[19]="selected='selected'";
														}
														if(strpos($a, 'Department of Business Administration') )
														{
													     $dept[20]="selected='selected'";
														}
														if(strpos($a, 'Department of Hotel Management') )
														{
													     $dept[21]="selected='selected'";
														}
														if(strpos($a, 'Department of Hospitality & Tourism') )
														{
													     $dept[22]="selected='selected'";
														}
														if(strpos($a, 'TAPMI School of Business') )
														{
													     $dept[23]="selected='selected'";
														}
														if(strpos($a, 'Department of Commerce') )
														{
													     $dept[24]="selected='selected'";
														}
														if(strpos($a, 'School of Humanities & Social Sciences') )
														{
													     $dept[25]="selected='selected'";
														}
										  ...
										  <select onchange="val<?php echo $o;?>()" id="dept<?php echo $o;?>1" name="dept<?php echo $o;?>" class="form-control input-rounded">
													...
													<option value="School of Architecture & Design, Manipal University Jaipur, Jaipur" <?php echo $dept[18]; ?>>School of Architecture & Design</option>
													<option value="Department of Journalism & Mass Communication, Manipal University Jaipur, Jaipur" <?php echo $dept[19]; ?>>Department of Journalism & Mass Communication</option>
													<option value="Department of Business Administration, Manipal University Jaipur, Jaipur" <?php echo $dept[20]; ?>>Department of Business Administration</option>
													<option value="Department of Hotel Management, Manipal University Jaipur, Jaipur" <?php echo $dept[21]; ?>>Department of Hotel Management</option>
													<option value="Department of Hospitality & Tourism, Manipal University Jaipur, Jaipur " <?php echo $dept[22]; ?>>Department of Hospitality & Tourism </option>
													<option value="TAPMI School of Business, Manipal University Jaipur, Jaipur" <?php echo $dept[23]; ?>>TAPMI School of Business</option>
													<option value=" Department of Commerce, Manipal University Jaipur, Jaipur" <?php echo $dept[24]; ?>> Department of Commerce</option>
													<option value=" School of Humanities & Social Sciences, Manipal University Jaipur, Jaipur" <?php echo $dept[25]; ?>>School of Humanities & Social Sciences</option>
													</select>
													...
													<tr><td>
													  <input type="text" name="typeahead" class="typeahead tt-query" autocomplete="off" spellcheck="false"  placeholder="Type your Query"></td></tr>
													<tr><td>
