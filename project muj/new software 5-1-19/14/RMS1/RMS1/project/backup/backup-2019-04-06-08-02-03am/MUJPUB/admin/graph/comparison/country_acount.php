<div class="col-sm-10 col-md-10">
                        <div class="card">
                            <div class="card-title">
                              <h4>Citation vs Article Count vs Countries </h4>

                            </div>
                            <div class="sales-chart">
                              <canvas id="chartJSContainer18"></canvas>
                            </div>
                        </div>
                        <!-- /# card -->
                    </div>
...
var ctx = document.getElementById('chartJSContainer18').getContext('2d');
