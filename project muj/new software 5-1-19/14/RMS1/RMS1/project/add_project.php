					...
					?>
                        <div class="card">
                            <div class="card-body">
								...
								<button type="button" class="btn btn-primary btn-flat m-b-10 m-l-5" style="position: absolute; right:20px;" onclick="window.location.href='add_project1.php'">Add Project</button>
