                ...
                <!-- Sidebar navigation-->
                 <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a  href="graph.php" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Graphical Analysis </span></a>
                        </li>
						<li> <a  href="researcher.php" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Authors </span></a>
						<li> <a class="has-arrow " href="research_unit.php"  aria-expanded="false"><i class="fa fa-university"></i><span class="hide-menu">Departments </span></a>
                        </li>
