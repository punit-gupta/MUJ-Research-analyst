                                    ...
                                    <table border=1 cellspacing="0" width="40%">
                                        <thead>
										  ...
										  <select onchange="val<?php echo $o;?>()" id="dept<?php echo $o;?>1" name="dept<?php echo $o;?>" class="form-control input-rounded">
													...
													<tr><td>
													<input type="text" name="txtCountry<?php echo $o;?>" id="txtCountry<?php echo $o;?>" placeholder="Author" class="typeahead" style="display:none;" value="<?php echo $row2[7] ?>"/>													
													<tr><td>
													<input type="text" name="txtCountry1<?php echo $o;?>" id="txtCountry1<?php echo $o;?>" placeholder="Affiliation" class="typeahead" style="display:block;" value="<?php echo $row2[2] ?>"/>
													</td></tr>
													</table>
													<script>
															$(document).ready(function () {
																$('#txtCountry1<?php echo $o;?>').typeahead({
																	source: function (query, result) {
																		$.ajax({
																			url: "ajax1/server.php",
																			data: 'query=' + query,            
																			dataType: "json",
																			type: "POST",
													...
													<script>
															$(document).ready(function () {
																$('#txtCountry<?php echo $o;?>').typeahead({
																	source: function (query, result) {
																		$.ajax({
																			url: "ajax1/server1.php",
																			data: 'query=' + query,            
																			dataType: "json",
																			type: "POST",
																			success: function (data) {
												...
												if(<?php echo $val;?>)
												{	document.getElementById('txtCountry1<?php echo $o;?>').style.display = 'none';
													document.getElementById('txtCountry<?php echo $o;?>').style.display = 'block';
													
												}
												
												function val<?php echo $o;?>() {
													var d = document.getElementById("dept<?php echo $o;?>1").value;
													 ...
													 if (d.localeCompare("NA")) {
															...
															{document.getElementById('txtCountry1<?php echo $o;?>').style.display = 'block';
															document.getElementById('txtCountry<?php echo $o;?>').style.display = 'none';}
