            ...
            <div class="container-fluid">
				...
				?>
				 ...
				 <div class="col-md-3">
					...
					<?php }           ?> <?php
                                                $sno = 1;
                                                $query = "SELECT * FROM `cite` WHERE cite.uid='$name'";
					...
					<div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h3 style="color: orange;"><a href="https://scholar.google.co.in/scholar?hl=en&as_sdt=0%2C5&q=<?php echo $row1[1]?>" style="color: orange;">Google Scholar</a></h3>
