 <?php 										$where="";
											...
											if(isset($_GET["journal"] )&& empty($journal))
											{
											  $journal="article.journal='".$_GET["journal"]."'";
											}
										    else if(isset($_GET["journal"] )&& !empty($year))
											{$journal=$journal." or article.journal='".$_GET["journal"]."'";
											}
											...
											if(isset($_GET["WEB"] )&& empty($index))
											{
											  $index="article.`web`='".$_GET["WEB"]."'";
											}
										    else if(isset($_GET["WEB"] )&& !empty($index))
											{$index=$index." or article.`web`='".$_GET["WEB"]."'";
											}
											...
											else if(isset($_GET["D27"] )&& !empty($dept))
											{$dept=$dept." or author.department='".$_GET["D27"]."'";
											}
											else if(isset($_GET["D28"] )&& !empty($dept))
											{$dept=$dept." or author.department='".$_GET["D28"]."'";
											}
											else if(isset($_GET["D29"] )&& !empty($dept))
											{$dept=$dept." or author.department='".$_GET["D29"]."'";
											}
											...
											$auth="";
											if(isset($_GET["author1"] )&& empty($auth))
											{
											  $auth="author.author='".$_GET["author1"]."'";
											}
											...
											$auth="";
											if(isset($_GET["author2"] )&& empty($auth))
											{
											  $auth="author.emp='".$_GET["author2"]."'";
											}
