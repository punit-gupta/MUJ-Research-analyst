...
<div class="header">
		...
		<?php
					...
					$result = mysqli_query($connect, $query);
					 ...
					 {
						 ?>
						 <li> <a  href="../admin/analysis.php" aria-expanded="false"><i class="fa fa-line-chart"></i><span class="hide-menu">Analysis</span></a>
                        </li>
						 <li> <a  href="../admin/graph.php" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Graphical Analysis</span></a>
                        </li>
						<li> <a  href="../admin/graph_world.php" aria-expanded="false"><i class="fa fa-globe"></i><span class="hide-menu">Global Foot Print</span></a>
                        </li>
					<?php	if($row1[8]==1)
					 { ?>
						
						<li> <a  href="../admin/graph_comparison.php" aria-expanded="false"><i class="fa fa-rocket"></i><span class="hide-menu">Comparative Analysis </span></a>
				   ...
				   <?php
						 ...
						 <li> <a  href="../admin/p_journal.php" aria-expanded="false"><i class="fa fa-bookmark"></i><span class="hide-menu">Popular Journals</span></a>
                        </li>
				   ...
				   <li> <a class="has-arrow " href="departments_menu.php"  aria-expanded="false"><i class="fa fa-university"></i><span class="hide-menu">Departments </span></a>
				    <li> <a  href="search.php" aria-expanded="false"><i class="fa fa-search"></i><span class="hide-menu">Search </span></a>
                        </li>
				   ...
				   if($row1[2]==1)
					 { ?>
						 ...
						 <li> <a  href="../admin/search.php" aria-expanded="false"><i class="fa fa-search"></i><span class="hide-menu">Search </span></a>
						 </li>
				   ...
				   <?php
					 ...
					 { ?>
						...
						<li> <a  href="../admin/upload_file3.php" aria-expanded="false"><i class="fa fa-upload"></i><span class="hide-menu">Upload</span></a>
                        </li>
				   ...
				   <?php
					 ...
					 { ?>
						...
						<li> <a  href="../admin/upload_cite.php" aria-expanded="false"><i class="fa fa-upload"></i><span class="hide-menu">Upload citation</span></a>
                        </li>
				   ...
				   <?php
					 ...
					 { ?>
						...
						<li> <a  href="../admin/delete_article.php" aria-expanded="false"><i class="fa fa-trash-o"></i><span class="hide-menu">Delete</span></a>
                        </li>
						<li> <a  href="../admin/updation_log.php" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Update Log </span></a>
                        </li>
				 ...
				 <li class="nav-label">EXTRA</li>
				   ...
				   <?php
					...
					<?php endwhile;?>
						 ...
						 <li> <a  href="../admin/contact.php" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Contact us</span></a>
                        </li>
