    ...
    <div id="main-wrapper">
      <?php include 'menua.php';?>
        ...
        <div class="page-wrapper">
			...
			{
				$query="UPDATE `author` SET `emp` = '".$_GET['id']."' WHERE author = '".$_GET['auth']."' and type='MUJ';";
				//echo $query;
							...
							<form method="get" action="#">
								...
								<?php
                                  ...
                                  endwhile;  ?>
								   ...
								   <input type="text" name="dept" hidden>
								 <input type="text" name="id" value="ID" class="form-control input-rounded">
								<input type='submit'>
								</form>
                            </div>
                        </div>
