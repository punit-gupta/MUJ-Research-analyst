					...
					<div class="col-lg-12">
                        <div class="card">
							...
							{$year=$_GET["year"];
								...
								$query = "select * from article where uid in (SELECT DISTINCT(author.uid) FROM `article` INNER JOIN author ON article.uid=author.uid where  article.document_type='Editorial' or article.document_type='Letter' and article.year='$year'and author.department='$dept')";
