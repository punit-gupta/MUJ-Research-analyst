                        ...
                        <div class="card">
							...
							<div id="editsum"> 
											...
											<?php 
												...
												?>
												<div class="esum">
                              <h6 align="justify">   <?php echo $auth;?>."<?php echo $row1[1];?>".<?php echo $row1[2];?>.<?php echo $row1[3];?>,<?php echo $row1[4];?>,pp.<?php echo $row1[5];?>.<a href='article.php?name=<?php echo $row1[27];?>' ><span class="badge badge-success">Link</a>
							</h6>
							</div>
