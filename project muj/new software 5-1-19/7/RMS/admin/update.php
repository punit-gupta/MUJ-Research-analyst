                ...
                <div class="row">
                    ...
                    <div class="card-body">
					 <li class="nav-label">Search UID</li>
									...
									$name = (isset($_GET["doi"]) && $_GET["doi"] != "" ? $_GET["doi"] : "");
									...
									?>
										<form method="get" action="">
											...
											<span class="input-group-btn"><button class="btn btn-primary btn-group-right" type="submit" value="Search UID">
											 ...
											 <tbody>
												...
												<tr> <td>Type</td> 				
												  <td>
												   ...
												   <input type="hidden" id=uid name="uid" value="<?php echo $row1[27];?>">
