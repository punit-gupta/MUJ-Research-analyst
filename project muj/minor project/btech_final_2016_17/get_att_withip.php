...
if ($aaa != 0) {
    ...
    for ($i=0; $i<$aaa; $i++)
	{
	   ...
	   <td>
		...
		?>
		<td><?php echo $view_in_terminal;?></td><td><?php echo $view_out_terminal;?></td>	
	  
	  <?php if ($a==2) {?><td><a href='get_att_withip.php?entry_no=<?php echo $entry_no; ?>&action=1&enroll=<?php echo $view_enroll; ?>'>Mark Out</a>
	  </td><td><a href='get_att_withip.php?entry_no=<?php echo $entry_no; ?>&action=2&enroll=<?php echo $view_enroll; ?>'>Disapprove</a></td><?php } ?></tr>
<?php
    }
