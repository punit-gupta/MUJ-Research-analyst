...
?>
<div id="divToPrint">
 <div id="mhead"><h2>Project Students Final Term Marks</h2></div>
...
if ($aaa != 0) {
    ...
    for ($i=0;$i<$aaa;$i++) 
	{
		...
		$super_marks = $student_data[$i]['T2_supervisor_marks'];
		$examiner1_marks = $student_data[$i]['T2_Marks1'];
		$examiner2_marks = $student_data[$i]['T2_Marks2'];
		$total_marks = $student_data[$i]['T2_total_marks'];
