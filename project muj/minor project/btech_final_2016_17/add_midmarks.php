...
if (isset($_GET['enroll']))
{
	...
	$recexaminer1=$rec_data['T1_Examiner1'];
	$recmarks1=$rec_data['T1_Marks1'];
	$recexaminer2=$rec_data['T1_Examiner2'];
	$recmarks2=$rec_data['T1_Marks2'];
	$recsmarks=$rec_data['T1_supervisor_marks'];
...
if (isset($_POST['submit'])) 
{
	...
	if ($sm_exists==1)
	{
		$str5 = "T1_supervisor_marks=".$smarks.", ";
	}
	else
	{
		$str5 ="";
	...
	$str6="T1_total_marks=".$total_marks;
...
?>
  <div id="mhead"><h2>Add Mid Presentation Marks</h2></div>
<?php 
...
<div id="auto">
		...
		<div><a href="view_student_marks.php">Print Mid Presentation Marks</a></div>
		<?php
}
else
{
