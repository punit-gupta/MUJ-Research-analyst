...
//change date at 3 places
//change total_hours at 2 places
...
if (isset($_POST['submit'])) 
{
	...
	if ($stu_supervisor=="HOD")
	{
		...
		$subject_mail="All BTech Final Year Project Students Attendance till 28th August 2016";
...
Btech Final Year Project Students is as under:<br /><br />";
	...
	else
	{
		...
		$subject_mail="BTech Final Year Project Students Attendance till 28th  August 2016";
				$message=$emailf."<br /><br />";
						$message .=$subject_mail."<br /><br />";
...
if (isset($_POST['submit']))
{
	...
	if ($aaa != 0) 
	{
		...
		$message .="<b>TOTAL HOURS : 20</b><br />";
		$message .="<b>ATTENDANCE UP TO 28th August 2016</b><br /><br />";
